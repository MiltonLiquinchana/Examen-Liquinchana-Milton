 ...
 * 
 */
@WebServiceClient(name = "Servicio", targetNamespace = "http://WService/", wsdlLocation = "file:/C:/Users/liqui/Documents/NetBeansProjects/Formregistro/src/conf/xml-resources/web-services/WebSreferences/wsdl/localhost_8080/WebSerivce/Servicio.wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICIO_QNAME = new QName("http://WService/", "Servicio");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/liqui/Documents/NetBeansProjects/Formregistro/src/conf/xml-resources/web-services/WebSreferences/wsdl/localhost_8080/WebSerivce/Servicio.wsdl");
    ...
    public Servicio getServicioPort() {
        return super.getPort(new QName("http://WService/", "ServicioPort"), Servicio.class);
    }
    ...
    public Servicio getServicioPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WService/", "ServicioPort"), Servicio.class, features);
    }
